...
function initPortfolioModal() {
  ...
  const projectData = {
    ...
    backend:    "Improved algorithmic and backend performance in a manufacturing software role by leveraging efficient data structures, resulting in approximately 33% higher execution efficiency along with better system responsiveness, reliability, and user productivity.",
		artifactpkg: "Developed a Python-based AI model artifact management toolkit for securely uploading, downloading, versioning, and modifying machine learning model artifacts across enterprise AI workflows, improving automation, maintainability, and deployment efficiency.",
    robotics: "Implemented intelligent multi-agent path planning and obstacle avoidance systems using the Lightweight Coordination Multi-Agent Planning (LCMAP) approach, integrating reinforcement learning, multi-task learning, ROS, and robotics algorithms such as A* and RRT for autonomous coordination and decision-making.",
